...
export function DoodleSquiggle({ className = "" }: { className?: string }) {
  return (
    <svg
      ...
      className={`h-2.5 fill-none stroke-[#195de6]/80 stroke-[3.5] stroke-linecap-round ${className}`}
    >
...
export function DoodleDoubleUnderline({ className = "" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 100 12"
      preserveAspectRatio="none"
      className={`h-3 fill-none stroke-amber-400 stroke-[2.5] stroke-linecap-round ${className}`}
    >
...
export function DoodlePlayfulStar({ className = "" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={`w-6 h-6 fill-amber-400 stroke-[#18181b] stroke-[2] stroke-linejoin-round ${className}`}
    >
...
export function DoodleSparkle({ className = "", size = 20 }: { className?: string; size?: number }) {
  return (
    <svg
      ...
      height={size}
      viewBox="0 0 24 24"
      className={`fill-violet-400 stroke-[#18181b] stroke-[2] stroke-linecap-round stroke-linejoin-round ${className}`}
    >
...
export function DoodleArrow({ className = "" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 48 32"
      fill="none"
      className={`stroke-[#195de6]/80 stroke-[2.5] stroke-linecap-round stroke-linejoin-round ${className}`}
    >
...
export function DoodleArrowCurly({ className = "" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 60 50"
      fill="none"
      className={`stroke-sky-400 stroke-[2] stroke-linecap-round stroke-linejoin-round ${className}`}
    >
...
export function SpeechBubble({
  ...
  return (
    <div
      className={`relative bg-[#195de6] text-white text-[13px] font-semibold py-2.5 px-4 rounded-2xl shadow-md border-2 border-[#18181b] max-w-[210px] text-center ${className}`}
    >
      {text}
      <div
        className={`absolute bottom-[-10px] w-0 h-0 border-l-[8px] border-l-transparent border-r-[8px] border-r-transparent border-t-[10px] border-t-[#195de6] z-10 ${
