...
export const works: WorkItem[] = [
  ...
  },
  {
    ...
    location: "Remote",
    type: "Contract",
    tagline: "AI-Native Automation Product",
    stack: ["Next.js", "OpenAI", "Python", "Tailwind CSS"],
    description: [
      "Worked as a full-stack engineer on Asmara.AI, an AI-native platform focused on intelligent automation and workflows for modern businesses. Contributed across the stack rather than owning the company.",
      "Built product features end to end: orchestrating LLM integrations, developing backend systems and APIs, and implementing user-facing interfaces in Next.js. Focused on shipping practical, reliable AI utility for real users.",
    ],
