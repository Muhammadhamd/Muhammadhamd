...
const portfolioLogos = [
  ...
  { name: "SwiftGo", src: "/portfolio-line-logos/swiftgologo.png" },
  { name: "SwiftWire", src: "/portfolio-line-logos/swiftwire.jpg" },
...
export default function HomeClient() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#1a1a1a] font-sans selection:bg-violet-100 selection:text-black overflow-x-clip relative pb-16">

      {/* Decorative scattered geometric shapes matching reference images */}
      <div className="absolute top-28 left-[10%] w-3 h-3 rounded-full bg-[#7c3bed] pointer-events-none animate-pulse" />
      <div className="absolute top-52 right-[8%] w-0 h-0 border-l-[7px] border-l-transparent border-r-[7px] border-r-transparent border-b-[12px] border-b-[#7c3bed] pointer-events-none rotate-12" />
      <div className="absolute top-[450px] left-[5%] w-3.5 h-3.5 bg-[#7c3bed] rotate-45 pointer-events-none" />
      <div className="absolute top-[800px] right-[10%] w-3 h-3 rounded-full bg-[#7c3bed] pointer-events-none" />
      <div className="absolute bottom-[600px] left-[8%] w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-b-[10px] border-b-zinc-950 pointer-events-none -rotate-12" />
      <div className="absolute bottom-40 right-[12%] w-3.5 h-3.5 bg-[#7c3bed] rotate-12 pointer-events-none" />
        ...
        <div className="max-w-[1100px] mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="font-display text-lg font-bold tracking-tight text-zinc-950 flex items-center gap-1.5">
              Muhammad Hamd
              <span className="w-2.5 h-2.5 rounded-full bg-[#7c3bed] inline-block animate-ping" />
            </span>
          </div>
      ...
      <section className="relative px-6 pt-16 pb-20 md:pt-24 md:pb-28 max-w-[1100px] mx-auto overflow-visible">
        ...
        <div className="max-w-3xl mx-auto flex flex-col items-center text-center relative z-10">
          ...
          <div className="relative mb-8 group select-none">
            ...
            {/* Subtle hand-drawn accents framing the avatar */}
            <DoodleArrow className="absolute left-[-52px] top-[20px] w-9 h-9 opacity-30 -rotate-12 pointer-events-none" />
            <DoodleLoop className="absolute right-[-45px] top-[10px] w-10 h-10 text-zinc-900 opacity-20 pointer-events-none" />
            <span className="absolute left-[-18px] bottom-[6px] w-1.5 h-1.5 rounded-full bg-[#7c3bed] pointer-events-none" />
            <span className="absolute right-[-20px] bottom-[18px] w-2 h-2 rounded-full border-2 border-zinc-300 pointer-events-none" />
            ...
            <div className="relative w-32 h-32 sm:w-36 sm:h-36 rounded-full border-4 border-zinc-950 bg-white shadow-[6px_6px_0px_0px_rgba(24,24,27,1)] flex items-center justify-center overflow-hidden transition-all duration-500 group-hover:scale-105 group-hover:translate-x-[-2px] group-hover:translate-y-[-2px] group-hover:shadow-[8px_8px_0px_0px_rgba(24,24,27,1)]">
              ...
              <div className="absolute inset-4 rounded-full bg-violet-50" />
              <Image
            ...
            <div className="absolute bottom-[-10px] right-[-32px] bg-white border-2 border-zinc-950 px-3 py-1.5 rounded-2xl shadow-[3px_3px_0px_0px_rgba(24,24,27,1)] flex items-center gap-1.5 z-20 hover:scale-105 transition-transform select-none">
              <span className="w-2 h-2 rounded-full bg-[#7c3bed] inline-block animate-pulse" />
          ...
          <div className="relative mb-4">
            ...
            <DoodleSquiggle className="w-48 text-[#7c3bed]/30 absolute bottom-[-10px] left-1/2 transform -translate-x-1/2" />
          </div>
          ...
          <div className="flex flex-wrap gap-4 items-center justify-center relative w-full mb-8 z-10">
            <Link
              href="/hire-me"
              className="inline-flex items-center justify-center font-display font-bold text-sm bg-zinc-950 hover:bg-zinc-800 text-white px-7 py-3.5 rounded-full border-2 border-zinc-950 shadow-[4px_4px_0px_0px_rgba(124,59,237,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(124,59,237,1)] active:translate-x-[0px] active:translate-y-[0px] transition-all cursor-pointer no-underline"
            >
              Hire Me
            ...
            <a
              ...
              className="inline-flex items-center justify-center font-display font-bold text-sm bg-[#7c3bed] hover:bg-[#6d28d9] text-white px-7 py-3.5 rounded-full border-2 border-zinc-950 shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(24,24,27,1)] active:translate-x-[0px] active:translate-y-[0px] transition-all cursor-pointer no-underline"
            >
              Let's Partner Up
            ...
            >
              ...
              <Sparkles className="ml-2 w-4 h-4 text-[#7c3bed]" />
            </button>
          </div>
      ...
      <section id="products" className="px-6 py-12 md:py-16 max-w-[1100px] mx-auto scroll-mt-24">
        <div className="text-center md:text-left mb-10 relative">
          ...
          <DoodleDoubleUnderline className="w-64 text-[#7c3bed] block h-2 mx-auto md:mx-0 mt-1" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white border-2 border-zinc-950 rounded-3xl p-8 shadow-[6px_6px_0px_0px_rgba(24,24,27,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[8px_8px_0px_0px_rgba(24,24,27,1)] transition-all flex flex-col justify-between relative group">
            <span className="absolute top-4 right-4 bg-violet-50 border-2 border-violet-100 text-[#7c3bed] font-display text-[9px] font-bold tracking-widest uppercase px-2.5 py-0.5 rounded-full">
              ACTIVE SAAS
            </span>
            ...
            <div className="border-t border-zinc-100 pt-5 flex items-center justify-between">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 text-xs font-bold text-[#7c3bed] hover:text-[#6d28d9] transition-colors"
              >
          ...
          <div className="relative mx-auto w-full max-w-[1100px] px-6">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center min-h-[420px]">
              ...
              <AnimatePresence mode="wait">
                {activeStep === 0 && (
                  ...
                  >
                    <span className="text-xs uppercase tracking-widest text-[#7c3bed] font-bold font-display block">WELCOME & ABOUT ME</span>
                    ...
                    <div className="flex flex-wrap gap-8 pt-4 select-none">
                      ...
                      <div className="flex items-center gap-3">
                        <FaLinkedin className="w-8 h-8 text-[#7c3bed] shrink-0" />
                      ...
                      <div className="flex items-center gap-3">
                        <Sparkles className="w-8 h-8 text-[#7c3bed] shrink-0" />
                        <div className="text-left">
                ...
                {activeStep === 1 && (
                  <motion.div
                    ...
                    className="text-left space-y-6"
                  >
                    <span className="text-xs uppercase tracking-widest text-[#7c3bed] font-bold font-display block">MY WORK & SPECIALTIES</span>
                    <h2 className="font-display text-3xl sm:text-4xl font-extrabold text-[#7c3bed] tracking-tight leading-none mb-4">
                      What I Work On
                    </h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-[580px]">
                      {[
                        ...
                        <div key={id} className="flex items-center gap-3 py-1">
                          <span className="text-[#7c3bed] font-extrabold text-lg">✓</span>
                ...
                {activeStep === 2 && (
                  <motion.div
                    ...
                    className="text-left space-y-6"
                  >
                    <span className="text-xs uppercase tracking-widest text-[#7c3bed] font-bold font-display block">SYSTEMS PHILOSOPHY</span>
                    ...
                    <div className="p-4 bg-violet-50/60 border border-violet-200/60 rounded-2xl max-w-[580px]">
                      <p className="text-xs font-extrabold text-[#7c3bed] mb-1 uppercase tracking-wider">The Engineering Core</p>
            ...
            <div className="hidden lg:flex lg:col-span-5 flex-col items-center justify-center">
              ...
              <div className="relative">
                ...
                <div className="relative w-80 h-[380px] md:w-80 md:h-[420px] rounded-3xl border-4 border-zinc-950 bg-white shadow-[8px_8px_0px_0px_rgba(124,59,237,1)] flex items-center justify-center overflow-hidden group">
                ...
                <div className="absolute top-[-30px] right-[-20px] w-4 h-4 rounded-full bg-[#7c3bed] animate-pulse pointer-events-none" />
                <div className="absolute top-[-10px] left-[-30px] w-3.5 h-3.5 bg-zinc-950 rotate-45 pointer-events-none" />
                <div className="absolute top-[40%] right-[-45px] w-0 h-0 border-l-[8px] border-l-transparent border-r-[8px] border-r-transparent border-b-[14px] border-b-[#7c3bed] rotate-12 pointer-events-none" />
                <div className="absolute bottom-[-15px] left-[-35px] w-0 h-0 border-l-[7px] border-l-transparent border-r-[7px] border-r-transparent border-b-[12px] border-b-zinc-950 -rotate-12 pointer-events-none" />
                <div className="absolute bottom-[-20px] right-[-10px] w-3.5 h-3.5 bg-[#7c3bed] rotate-12 pointer-events-none" />

                {/* Bottom tag indicator */}
                <div className="absolute bottom-[-15px] left-1/2 transform -translate-x-1/2 bg-zinc-950 text-white border-2 border-zinc-950 text-[10px] font-extrabold tracking-widest uppercase px-4 py-1.5 rounded-full shadow-[3px_3px_0px_0px_rgba(124,59,237,1)] z-20 whitespace-nowrap select-none">
                  AI SYSTEMS BUILDER
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-[#fafbfd] border-2 border-zinc-950 rounded-3xl p-6 shadow-[4px_4px_0px_0px_rgba(24,24,27,1)]">
            <h3 className="font-display font-extrabold text-[17px] text-zinc-900 mb-4 flex items-center gap-2">
              <Terminal className="text-[#7c3bed] w-5 h-5 leading-none shrink-0" />
              Engineering & Infra
            </h3>
          ...
          <div className="bg-[#fdfafb] border-2 border-zinc-950 rounded-3xl p-6 shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] flex flex-col justify-between">
            <div>
              <h3 className="font-display font-extrabold text-[17px] text-zinc-900 mb-4 flex items-center gap-2">
                <PenTool className="text-[#7c3bed] w-5 h-5 leading-none shrink-0" />
                Writing & Thinking
              </h3>
            ...
            <Link
              href="/blog"
              className="mt-4 pt-4 border-t border-zinc-200/50 text-[11px] text-[#7c3bed] font-bold no-underline inline-flex items-center gap-1 hover:gap-1.5 transition-all"
            >
          ...
          <div className="bg-[#fcfcfa] border-2 border-zinc-950 rounded-3xl p-6 shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] flex flex-col justify-between">
            <div>
              <h3 className="font-display font-extrabold text-[17px] text-zinc-900 mb-4 flex items-center gap-2">
                <Award className="text-[#7c3bed] w-5 h-5 leading-none shrink-0" />
                Current Focus
              </h3>
              ...
              {works.map((w) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <p className="text-sm font-bold text-zinc-950 group-hover:text-[#7c3bed] transition-colors leading-tight">
                        {w.company}
                      </p>
                  ...
                  <div className="w-8 h-8 rounded-full border border-zinc-200 group-hover:border-[#7c3bed] group-hover:bg-violet-50 flex items-center justify-center text-zinc-400 group-hover:text-[#7c3bed] transition-all shrink-0 ml-2">
                    <ArrowRight size={13} />
                  </div>
                </Link>
              ))}
      ...
      <section className="px-6 py-12 max-w-[1100px] mx-auto">
        <div className="text-center mb-10">
          ...
          <DoodleSquiggle className="w-48 text-[#7c3bed]/30 block h-2 mx-auto mt-1" />
        </div>

        {/* 3 Step custom pipeline resembling mockup 1 & 4 */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          <DoodleArrowCurly className="w-12 h-12 absolute left-[30%] top-[-20px] text-[#7c3bed] hidden lg:block -rotate-12" />
          <DoodleLoop className="w-12 h-12 absolute left-[64%] top-[10px] text-violet-200 hidden lg:block rotate-45" />
          ...
          <div className="bg-white border-2 border-zinc-950 rounded-3xl p-6 shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] relative flex flex-col justify-between">
            <div>
              <div className="w-10 h-10 rounded-2xl bg-violet-50 flex items-center justify-center font-bold text-[#7c3bed] mb-4">
                1
              </div>
          ...
          {/* Step 3 */}
          <div className="bg-white border-2 border-zinc-950 rounded-3xl p-6 shadow-[4px_4px_0px_0px_rgba(24,24,27,1)] relative flex flex-col justify-between border-l-[#7c3bed] border-l-4">
            <div>
              <div className="w-10 h-10 rounded-2xl bg-violet-50 flex items-center justify-center font-bold text-[#7c3bed] mb-4">
                3
              </div>
            ...
            <div className="mt-4 pt-4 border-t border-zinc-100 text-[11px] text-[#7c3bed] font-bold">
      ...
      <section id="contact" className="px-6 py-12 md:py-16 max-w-[1100px] mx-auto scroll-mt-24">
        <div className="bg-[#18181b] border-4 border-zinc-950 text-white rounded-3xl p-8 md:p-12 shadow-[8px_8px_0px_0px_rgba(124,59,237,0.95)] relative overflow-hidden text-center md:text-left">
          <DottedPattern className="w-[150px] h-[150px] right-2 top-2 opacity-10" />
          
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            <div className="md:col-span-8">
              <span className="text-xs uppercase tracking-widest text-violet-300 font-bold font-display block mb-1">GET IN TOUCH</span>
            ...
            <div className="md:col-span-4 flex flex-col sm:flex-row md:flex-col gap-4 items-center md:items-end justify-center w-full">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto inline-flex items-center justify-center font-display font-bold text-xs bg-[#7c3bed] hover:bg-[#6d28d9] text-white px-6 py-3.5 rounded-full border-2 border-white/20 transition-all no-underline"
              >
      ...
      <footer className="mt-12 px-6 border-t-2 border-zinc-900/5 pt-12 max-w-[1100px] mx-auto">
        ...
        <nav className="mt-10 grid gap-8 border-t border-zinc-100 pt-8 sm:grid-cols-2 md:grid-cols-4 text-[12.5px]">
          <div>
            <p className="text-[11px] uppercase tracking-widest text-zinc-400 font-extrabold mb-3">Explore</p>
            <ul className="space-y-2">
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="text-zinc-500 hover:text-[#7c3bed] no-underline transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <p className="text-[11px] uppercase tracking-widest text-zinc-400 font-extrabold mb-3">Services</p>
            <ul className="space-y-2">
              {services.map((s) => (
                <li key={s.slug}>
                  <Link href={`/services/${s.slug}`} className="text-zinc-500 hover:text-[#7c3bed] no-underline transition-colors">
                    {s.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <p className="text-[11px] uppercase tracking-widest text-zinc-400 font-extrabold mb-3">Hire in</p>
            <ul className="space-y-2">
              <li>
                <Link href="/ai-engineer-pakistan" className="text-zinc-500 hover:text-[#7c3bed] no-underline transition-colors">
                  AI Engineer in Pakistan
                </Link>
              </li>
              <li>
                <Link href="/ai-engineer-karachi" className="text-zinc-500 hover:text-[#7c3bed] no-underline transition-colors">
          ...
          <div>
            <p className="text-[11px] uppercase tracking-widest text-zinc-400 font-extrabold mb-3">Case Studies</p>
            <ul className="space-y-2">
              {works.map((w) => (
                <li key={w.slug}>
                  <Link href={`/work/${w.slug}`} className="text-zinc-500 hover:text-[#7c3bed] no-underline transition-colors">
                    {w.company}
                  </Link>
                </li>
              ))}
